                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _buildSupportButton(
                          ...
                          icon: Icons.email,
                          label: 'ایمیل',
                          url: 'mailto:h3dev.Fazli@gmail.com',
                        ),
                        _buildSupportButton(
                          context,
                          icon: Icons.code,
                          label: 'گیت‌هاب',
                          url: 'https://github.com/tsshack/vispar-GUI',
                        ),
                        _buildSupportButton(
                          context,
                          icon: Icons.camera_alt,
                          label: 'اینستاگرام',
                          url: 'https://www.instagram.com/h3dev.Fazli',
                        ),
                      ],
                    ),
                  ],
  ...
  Future<void> _checkForUpdates() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://api.github.com/repos/tsshack/vispar-GUI/releases'),
